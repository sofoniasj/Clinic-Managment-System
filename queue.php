        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="registered.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Registered</a>
                    <a href="queue.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Queue</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
